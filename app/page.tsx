...
export default function Home() {
  ...
  const links = [
        ...
        { title: "箱根结果", desc: "本届比赛结果", href: `/ekiden/hakone/${year}/result`, isDisabled: true },
        { title: "箱根排名", desc: "本届比赛各种数据排名", href: `/ekiden/hakone/${year}/rank`, isDisabled: true },
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 16 }}>
          {links.map((it, idx) => (
            it.isDisabled ? (
              <div
                key={idx}
                onClick={() => message.info("该功能尚未开发完成或比赛尚未开始")}
              ...
              >
                <div className="card disabled" style={{ border: "1px solid #e5e7eb", borderRadius: 12, padding: 16, background: "#fafafa" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                    ...
                    <span style={{ fontSize: 12, color: "#999", border: "1px solid #ddd", borderRadius: 999, padding: "2px 8px" }}>比赛未开始</span>
                  </div>
